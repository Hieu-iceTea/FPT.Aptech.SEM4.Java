<%@ page import="com.example.WCD_WebComponentDevelopment.MVC_First_Demo.Model.User" %>
<%@ page import="java.util.List" %>

<jsp:useBean id="users" scope="request" type="java.util.List<com.example.WCD_WebComponentDevelopment.MVC_First_Demo.Model.User>"/>
