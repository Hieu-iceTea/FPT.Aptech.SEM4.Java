<%@ page import="com.example.WCD_WebComponentDevelopment.MVC_First_Demo.Model.Status" %><%--
...
<form action="task/edit/?id=${ myTask.id }" method="post">
    ...
    <select name="status" required style="width: 33%">
        ...
        <c:set var="StatusValues"
               value="<%=com.example.WCD_WebComponentDevelopment.MVC_First_Demo.Model.Status.values()%>"/>
