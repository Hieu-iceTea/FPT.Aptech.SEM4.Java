<%@ page import="com.example.WCD_WebComponentDevelopment.MVC_First_Demo.Model.MyTask" %>
<%@ page import="java.util.List" %>

<jsp:useBean id="myTasks" scope="request" type="java.util.List<com.example.WCD_WebComponentDevelopment.MVC_First_Demo.Model.MyTask>"/>
