...
<%--<jsp:useBean id="myTask"
             scope="request"
             class="com.example.WCD_WebComponentDevelopment.MVC_Demo.MyTask"
             type="com.example.WCD_WebComponentDevelopment.MVC_Demo.MyTask"
             beanName="com.example.WCD_WebComponentDevelopment.MVC_Demo.MyTask"
/>--%>

<jsp:useBean id="myTask"
             scope="request"
             type="com.example.WCD_WebComponentDevelopment.MVC_Demo.Model.MyTask"
/>
