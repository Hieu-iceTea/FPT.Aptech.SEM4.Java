...
DROP DATABASE IF EXISTS `IASF`;
CREATE DATABASE IF NOT EXISTS `IASF` CHARACTER SET utf8 COLLATE utf8_unicode_ci;

USE `IASF`;

SET time_zone = '+07:00';
ALTER DATABASE `IASF` CHARACTER SET utf8 COLLATE utf8_unicode_ci;
